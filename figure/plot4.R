...
with(energy2,{
  plot(date2,Global_active_power,type="l",col="black",
       xlab="Date Time",ylab="Global Active Power")
  
  plot(date2,Voltage,type="l",col="black",xlab="Date Time",ylab="Voltage")
  
  plot(date2,Sub_metering_1,type="l",col="black",xlab="Date Time",ylab="Energy Submetering")
  ...
  plot(date2,Global_reactive_power,type="l",col="black",xlab="Date Time",
